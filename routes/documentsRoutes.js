...
console.log('test router document');
...
router.post('/:registrationId', isAuthenticated, upload.single('document'), documentController.submitDocument);
...
router.post('/:id/:type', isAdmin, tripController.addRequiredDocument);
